                    ...
                    >
                      ...
                      <div className="-space-y-px rounded-md shadow-sm">
                        <div>
                          ...
                          <input
                            ...
                            type="text"
                            required
                            className="relative block w-full appearance-none rounded-none rounded-t-md border border-#7f66de px-3 py-2 text-#7f66de placeholder-#7f66de focus:z-10 focus:border-indigo-500 focus:outline-none focus:ring-indigo-500 sm:text-sm"
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        <div className="text-sm">
                          <a
                            href=""
                            className="font-medium text-#7f66de hover:opacity-75"
                          >
